...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Custom Hugaira color palette
        "beige-light": "rgb(var(--color-beige-light) / <alpha-value>)",
        ...
        "blush-light": "rgb(var(--color-blush-light) / <alpha-value>)",
      ...
      backgroundImage: {
        ...
        "floral-pattern": "url('/patterns/floral-light.svg')",
      },
    },
  },
