    ...
    <footer className="bg-beige text-foreground">
      <div className="container-custom py-12">
        ...
        <div className="floral-bg rounded-lg p-6 mb-10 text-center max-w-3xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-playfair mb-3">
            Join Our Community
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              Hugaira Store offers elegant, modest fashion for Muslim women. Our
              collections are designed with quality, comfort, and style in mind.
            </p>
            <div className="flex space-x-3">
              ...
              <a
                href="mailto:contact@hugairastore.com"
                className="text-brown hover:text-brown-dark transition-colors"
                aria-label="Email"
              >
                <Mail size={18} />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link
                  href={`/${locale}/products/new-arrivals`}
                  className="text-muted-foreground hover:text-foreground transition-colors"
                >
                  New Arrivals
                </Link>
              ...
              <li>
                <Link
                  href={`/${locale}/products/best-sellers`}
                  className="text-muted-foreground hover:text-foreground transition-colors"
                >
                  Best Sellers
                </Link>
        ...
        <div className="mt-12 pt-6 border-t border-border text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Hugaira Store. All rights
            reserved.
          </p>
